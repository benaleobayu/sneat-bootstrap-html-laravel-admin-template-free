...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        try {
            ...
            $permission = Permission::create(['name' => 'Show.Pelanggan']);
            ...
            $permission = Permission::create(['name' => 'Show.Langganan']);
            ...
            $permission = Permission::create(['name' => 'Show.Kurir']);
            ...
            $permission = Permission::create(['name' => 'Show.Pesanan']);
            ...
            $permission = Permission::create(['name' => 'Show.Pembayaran']);
            ...
            $permission = Permission::create(['name' => 'Show.Dokumentasi']);
            ...
            $permission = Permission::create(['name' => 'Show.Admin']);
            ...
            $permission = Permission::create(['name' => 'Show.Daerah']);
            ...
            $permission = Permission::create(['name' => 'Show.Bunga']);
            ...
            $permission = Permission::create(['name' => 'Show.Hari']);
